export const features = [
    {
      ...
      text: "With DigitalDwaar, tedious tasks are history. Automation and smart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.",
      button: {
  ...
  export const faq = [
    {
      id: "0",
      question: "How easy is to deal with DigitalDwaar?",
      answer:
        "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
    },
    {
      id: "1",
      question: "Can I integrate DigitalDwaar with other platforms?",
      answer:
        "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
    },
    {
  ...
  export const testimonials = [
    {
      ...
      comment:
        "DigitalDwaar customer support is second to none! They’re like my tech superheroes, always there when I need them.",
    },
    {
      id: "1",
      name: "Mark Erixon",
    ...
    },
    {
      ...
      comment:
        "Switched to DigitalDwaar last month, and I'm already seeing results. Best decision for our team!",
    },
    {
      id: "5",
      name: "Jim Bradley",
